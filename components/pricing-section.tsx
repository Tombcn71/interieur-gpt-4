    ...
    <section className="py-20">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Eenvoudige prijzen</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Kies het pakket dat bij je past en begin met het transformeren van je ruimtes
          </p>
        </div>
          ...
          {pricingTiers.map((tier) => (
            <div
              ...
              className={`rounded-2xl overflow-hidden border ${
                tier.popular ? "border-blue-500 shadow-lg shadow-blue-100" : "border-gray-200"
              }`}
            >
              {tier.popular && (
                <div className="bg-blue-500 text-white py-1.5 text-center text-sm font-medium">Meest populair</div>
              )}
              ...
              <div className="p-6">
                ...
                <Button
                  asChild
                  className={`w-full rounded-full ${tier.popular ? "bg-blue-500 hover:bg-blue-600" : ""}`}
                >
        ...
        <div className="mt-12 text-center text-sm text-muted-foreground">
          <p>
            Alle prijzen zijn inclusief BTW. Gebruik code <span className="font-bold">BF60</span> voor 60% korting.
          </p>
        </div>
      </div>
    </section>
